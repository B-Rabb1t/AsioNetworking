        ...
        public:
            ...
            void MessageClient(std::shared_ptr<connection<T>> client, const message<T> &msg)
            {
                ...
                else
                {
                    ...
                    client.reset();
                    m_deqConnections.erase(std::remove(begin(m_deqConnections), end(m_deqConnections), client),
                                           end(m_deqConnections));
                }
            }
            ...
            void MessageAllClients(const message<T> &msg, std::shared_ptr<connection<T>> pIgnoreClient = nullptr)
            {
                ...
                if (bInvalidClientExists)
                    m_deqConnections.erase(std::remove(begin(m_deqConnections), end(m_deqConnections), nullptr),
                                           end(m_deqConnections));
            }
